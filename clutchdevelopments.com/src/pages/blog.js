      ...
      <section class="blog">
        <div class="header">
          <div class="headerobjectswrapper">
              <h1>Extra, Extra! Web Dev Media</h1>
          </div>
          <div class="subhead">Ben Lomond, CA - {formatDate(new Date())}  - Seven Pages</div>
        </div>
        <div class="content">
          <div class="collumns">
              <div class="collumn">
                ...
                <Link className="newsLink" to="/blog-post/">Read More on page {getRandomizer(1, 200)} →</Link>
              </div>
              <div class="collumn">
                <div class="head">
