...
const Particles = () => (
  <Layout>
    <SEO title="Byron Wade: Experiment - Partical.js" />
    <section>
      <Container>
        <Row className="align-items-center">
          <Col md={{ span: 6 }}>
            <p className="text-danger">Experiment still in progress...</p>
            <h1 className="hero-heading">Particles.js</h1>
            <p className="lead mt-1 mb-1 font-weight-light">A lightweight JavaScript library for creating particles.</p>
            ...
            <ul className="list-inline">
              <li className="list-inline-item"><a className="btn btn-sm btn-primary" href="https://vincentgarreau.com/particles.js/">Link to website</a></li>
              <li className="list-inline-item"><a className="btn btn-sm btn-dark" href="https://github.com/VincentGarreau/particles.js/">Link to github</a></li>
            </ul>
          </Col>
